...
const Login = () => {
  ...
  const handleSignInWithEmailAndPass = async (event) => {
    ...
    fetch("https://inventory-management-server-f0ho.onrender.com/login", {
      method: "POST",
  ...
  return (
    <div className="container mx-auto p-3">
      ...
      <div className="w-full md:w-1/2 mx-auto">
        <h3 className="text-3xl text-blue-500 font-semibold mb-5 text-left">
          Please Login
        </h3>
        <form
        ...
        >
          ...
          <p className="mb-3 text-gray-800">
            Forgot Password?{" "}
            <span
              className="font-semibold text-red-400 hover:text-red-500 cursor-pointer"
          ...
          <button
            ...
            className="w-2/3 mx-auto text-white bg-blue-500 hover:bg-blue-400 rounded-md px-3 py-1"
          >
