...
const ManageInvntory = () => {
  ...
  return (
    <div className="container mx-auto p-3">
      ...
      <table className="w-full text-left text-xl mb-5">
        <thead>
          <tr>
            ...
            <th className="border border-gray-900 text-gray-900 p-1 hidden md:block">
              Added By
            </th>
        ...
        <tbody>
          {products.map((product) => (
            <tr key={product._id}>
              ...
              <td className="border border-gray-900 text-gray-800 p-1 hidden md:block">
                {product.user}
              </td>
              <td className="border border-gray-900 text-gray-800 p-1">
                {product.quantity}
      ...
      <Link
        className="text-xl text-white font-semibold bg-blue-500 rounded-md px-3 py-1 hover:bg-blue-400 mx-auto"
        to="/add"
      >
        Add New Item
      </Link>
